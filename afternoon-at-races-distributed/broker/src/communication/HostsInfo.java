...
/**
 * Class that contains all the information relative to hostnames and ports of
 * remote machines.
 */
...
//    public static final String BROKER_HOSTNAME = "l040101-ws09.ua.pt";
     ...
     */
    public static final int GENERAL_REPOSITORY_PORT = 22401;

    /**
     * Port number of the Stable server.
     */
    public static final int STABLE_PORT = 22402;

    /**
     * Port number of the Control Centre server.
     */
    public static final int CONTROL_CENTRE_PORT = 22403;

    /**
     * Port number of the Paddock server.
     */
    public static final int PADDOCK_PORT = 22404;

    /**
     * Port number of the Racing Track server.
     */
    public static final int RACING_TRACK_PORT = 22405;
